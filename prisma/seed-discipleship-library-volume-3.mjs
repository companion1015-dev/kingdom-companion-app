// One-off seed script for "Christian Character & Relationships" (Volume 3).
// Run with: node prisma/seed-discipleship-library-volume-3.mjs

import 'dotenv/config'
import { PrismaClient } from '@prisma/client'
import { PrismaPg } from '@prisma/adapter-pg'
import { book, chapters } from './seed-data/christian-character-and-relationships-volume-3.mjs'
