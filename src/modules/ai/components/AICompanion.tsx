                        ...
                        return (
                          <>
                            ...
                            <div className="flex items-center gap-3 mt-2 px-1">
                              ...
                              <a href={getBibleHref(parsed.scriptures, parsed.nextStep)} className="flex items-center gap-1.5 text-xs text-charcoal/35 dark:text-cream/35 hover:text-gold font-body transition-colors">
...
}// Real fix: "Open Bible" always linked to the generic /bible page, ignoring
// the specific passage named in the Scriptures/Next Step sections. Now
// extracts the first real book+chapter reference and deep-links to it.
