  ...
  return (
    <div className="min-h-screen bg-cream-gradient">
      ...
      <main className="max-w-2xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-serif text-navy mb-2">Terms of Use</h1>
        ...
        <div className="bg-white rounded-2xl border border-navy/8 p-6 sm:p-8 space-y-6 text-sm text-charcoal/70 font-body leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">1. Acceptance of terms</h2>
            <p>By using Kingdom Companion, you agree to these terms. If you do not agree, please do not use the app.</p>
          </section>

          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">2. What we offer</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">3. Your account</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">4. Acceptable use</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">5. Your content</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">6. The AI Companion</h2>
            <p>The AI Companion offers Scripture-centred reflection and encouragement, generated by AI. It is <strong className="text-navy">not a substitute for pastoral care, professional counselling, or medical or mental health advice</strong>. If you are in crisis, please contact a crisis line or emergency services directly rather than relying on the AI Companion.</p>
          </section>

          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">7. Donations</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">8. Intellectual property</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">9. Disclaimers</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">10. Changes</h2>
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-navy mb-2">11. Contact us</h2>
