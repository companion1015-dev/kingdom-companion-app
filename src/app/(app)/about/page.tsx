  ...
  return (
    <div className="min-h-screen bg-cream dark:bg-navy-dark-gradient">
      ...
      <main className="max-w-2xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-serif text-navy dark:text-cream mb-1">About Kingdom Companion</h1>
        <p className="text-gold-dark italic mb-10">Scripture · Peace · Purpose</p>

        <section className="mb-10">
          <h2 className="text-sm font-medium uppercase tracking-wide text-navy/40 dark:text-cream/40 mb-3">What Kingdom Companion Is</h2>
          <p className="text-navy/80 dark:text-cream/80 leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-sm font-medium uppercase tracking-wide text-navy/40 dark:text-cream/40 mb-3">Our Mission</h2>
          <p className="text-navy/80 dark:text-cream/80 leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-sm font-medium uppercase tracking-wide text-navy/40 dark:text-cream/40 mb-3">Our Vision</h2>
          <p className="text-navy/80 dark:text-cream/80 leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-10">
          <div className="p-5 rounded-xl bg-white dark:bg-navy-dark border border-navy/8">
            <BookOpen className="w-5 h-5 text-gold-dark mb-2" />
            <h3 className="font-serif text-navy dark:text-cream mb-1">The Role of Scripture</h3>
          ...
          <div className="p-5 rounded-xl bg-white dark:bg-navy-dark border border-navy/8">
            ...
            <h3 className="font-serif text-navy dark:text-cream mb-1">The Role of AI</h3>
            <p className="text-sm text-navy/60 dark:text-cream/60 leading-relaxed">
          ...
          <div className="p-5 rounded-xl bg-white dark:bg-navy-dark border border-navy/8">
            ...
            <h3 className="font-serif text-navy dark:text-cream mb-1">Free &amp; Private</h3>
            <p className="text-sm text-navy/60 dark:text-cream/60 leading-relaxed">
          ...
          <div className="p-5 rounded-xl bg-white dark:bg-navy-dark border border-navy/8">
            ...
            <h3 className="font-serif text-navy dark:text-cream mb-1">Voluntary Support</h3>
            <p className="text-sm text-navy/60 dark:text-cream/60 leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-sm font-medium uppercase tracking-wide text-navy/40 dark:text-cream/40 mb-3">Who&rsquo;s Behind This</h2>
          <p className="text-navy/80 dark:text-cream/80 leading-relaxed">
